...
Android 构建依赖 Android SDK、NDK、Java 21、Rust 与 `cargo-ndk 4.1.2`；UniFFI 绑定生成器由 core crate 的本地可选二进制自动编译。iOS 构建还需要 macOS、Xcode、XcodeGen 和具有 Packet Tunnel 权限的有效签名团队。
